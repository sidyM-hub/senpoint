"""
Django settings for scanpointage project.
...
SECRET_KEY = 'bppaj3v7zv$*ekjndw)82i=^=bf6#ed7)1^ofrze$nmh&b0uoj'
...
ROOT_URLCONF = 'scanpointage.urls'
...
WSGI_APPLICATION = 'scanpointage.wsgi.application'
